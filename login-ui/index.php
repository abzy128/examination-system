...
<body>
	...
	<!-- This div contains login form-->
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<!-- Sign in text and picture at background-->
				<div class="login100-form-title" style="background-image: url(login-ui/images/bg-01.jpg);">
					<span class="login100-form-title-1">
						Вход в аккаунт
					</span>
				</div>
				<!-- Two data input fields-->
				<form method="post" id="examineeLoginFrm" class="login100-form validate-form">
					<div class="wrap-input100 validate-input m-b-26" data-validate="Требуется эл. почта">
						<span class="label-input100">Эл. почта</span>
						<input maxlength="32" class="input100" type="email" name="username" placeholder="Введите эл. почту">
						<span class="focus-input100"></span>
					</div>

					<div class="wrap-input100 validate-input m-b-18" data-validate = "Требуется пароль">
						<span class="label-input100">Пароль</span>
						<input maxlength="32" class="input100" type="password" name="password" placeholder="Введите пароль">
						<span class="focus-input100"></span>
					</div>
					<!-- Sign in button -->
