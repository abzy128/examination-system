...
<?php 
   ...
   $selExam = $conn->query("SELECT * FROM exams WHERE ex_id='$exId' ");
   $selExamRow = $selExam->fetch(PDO::FETCH_ASSOC);

   $courseId = $selExamRow['cou_id'];
   $selCourse = $conn->query("SELECT cou_name as courseName FROM courses WHERE cou_id='$courseId' ")->fetch(PDO::FETCH_ASSOC);
 ?>
...
<div class="app-main__outer">
        <div class="app-main__inner">
            <div class="app-page-title">
                <div class="page-title-wrapper">
                     <div class="page-title-heading">
                        <div> Управление тестом
                            <div class="page-title-subheading">
                              Изменение теста "<?php echo $selExamRow['ex_title']; ?>"
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                  <div class="col-md-6">
                      <div class="main-card mb-3 card">
                          <div class="card-header">
                            <i class="header-icon lnr-license icon-gradient bg-plum-plate"> </i>Информация о тесте
                          </div>
                          <div class="card-body">
                           <form method="post" id="updateExamFrm">
                               <div class="form-group">
                                ...
                                <select class="form-control" name="courseId" required="">
                                  ...
                                  <?php 
                                    $selAllCourse = $conn->query("SELECT * FROM courses ORDER BY cou_id DESC");
                              ...
                              <div class="form-group">
                                ...
                                <input type="" maxlength="32" name="examTitle" class="form-control" required="" value="<?php echo $selExamRow['ex_title']; ?>">
                              </div>  

                              <div class="form-group">
                                <label>Описание теста</label>
                                <input type="" maxlength="128" name="examDesc" required class="form-control" required="" value="<?php echo $selExamRow['ex_description']; ?>">
                              </div>  

                              <div class="form-group">
                                <label>Лимит времени</label>
                                <select class="form-control" name="examLimit" required="">
                                  <option value="<?php echo $selExamRow['ex_time_limit']; ?>"><?php echo $selExamRow['ex_time_limit']; ?> минут</option>
                              ...
                              <div class="form-group">
                                ...
                                <input type="number" min="1" max="99" required name="examQuestDipLimit" class="form-control" value="<?php echo $selExamRow['ex_questlimit_display']; ?>"> 
                              </div>
                  ...
                  <div class="col-md-6">
                    <?php 
                        // This line selects all questions from database and puts it into variable
                        $selQuest = $conn->query("SELECT * FROM exam_questions WHERE exam_id='$exId' ORDER BY eqt_id desc");
                    ?>
                     <div class="main-card mb-3 card">
                          <div class="card-header"><i class="header-icon lnr-license icon-gradient bg-plum-plate"> </i>Вопросы теста
                          ...
                          <div class="card-body" >
                            ...
                            <?php 
                               // if statement that check are there any questions in the test
                                    ...
                                    <table class="align-middle mb-0 table table-borderless table-striped table-hover" id="tableList">
                                        ...
                                        <tbody>
                                          <?php 
                                            ...
                                            {
                                               $i = 1;
                                               // This loop cycles throught all questions and creates HTML markup for them
                                               while ($selQuestionRow = $selQuest->fetch(PDO::FETCH_ASSOC)) { ?>
                                                <tr>
                                                        ...
                                                        <td class="text-center">
                                                         <a rel="facebox" href="facebox_modal/updateQuestion.php?id=<?php echo $selQuestionRow['eqt_id']; ?>" class="btn btn-sm btn-primary">Изменить</a>
                                                         <button type="button" id="deleteQuestion" data-id='<?php echo $selQuestionRow['eqt_id']; ?>'  class="btn btn-danger btn-sm">Удалить</button>
                                                        </td>
                                                    </tr>
                                               <?php }
                                            }
                                            ...
                                            { ?>
                                                <tr>
                                                  <td colspan="2">
                                                    <h3 class="p-3">Курс не найден</h3>
                                                  </td>
                                                </tr>
                                            <?php }
                                           ?>
                               ...
                               { ?>
                                  <h4 class="text-primary">Вопрос не найден...</h4>
                                 <?php
                               }
                             ?>
                               </div>
