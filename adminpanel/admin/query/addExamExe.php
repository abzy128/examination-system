<?php 
 ...
 $selCourse = $conn->query("SELECT * FROM exams WHERE ex_title='$examTitle' ");
 ...
 else
 {
	...
	$insExam = $conn->query("INSERT INTO exams(cou_id,ex_title,ex_time_limit,ex_questlimit_display,ex_description) VALUES('$courseSelected','$examTitle','$timeLimit','$examQuestDipLimit','$examDesc') ");
	if($insExam)
	{
