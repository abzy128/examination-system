...
<div class="app-main__inner">
    ...
    <div class="col-md-12 p-0 mb-4">
        ...
        <?php 
            // Fetching questions from databse 
            $selQuest = $conn->query("SELECT * FROM exam_questions WHERE exam_id='$examId' ORDER BY rand() LIMIT $exDisplayLimit ");
                ...
                ?>
                       <tr>
                             <td style="padding: 20px;">
                                 <button type="button" class="btn btn-xlg btn-warning p-3 pl-4 pr-4" id="resetExamFrm">Сбросить</button>
                                 <input name="submit" type="submit" value="Отправить" class="btn btn-xlg btn-primary p-3 pl-4 pr-4 float-right" id="submitAnswerFrmBtn">
                             </td>
                         </tr>
